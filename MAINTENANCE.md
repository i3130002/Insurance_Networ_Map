...
- `data/needs-geocoding.json` (currently 181 entries) is exactly the backlog of rows without usable pins.
...
Rate-limit politely: 1 req/sec Nominatim, ~181 entries ≈ 4 min.
